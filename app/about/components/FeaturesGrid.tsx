...
const FeaturesGrid = () => {
  return (
    <section className="w-full  flex items-center justify-center p-8 relative overflow-hidden">
      ...
      {/* Subtle diagonal texture overlay (Optional, matches the faint line in your ss) */}
      <div className="absolute inset-0 bg-[linear-gradient(110deg,transparent_45%,rgba(255,255,255,0.03)_45%,rgba(255,255,255,0.03)_55%,transparent_55%)] pointer-events-none" />
